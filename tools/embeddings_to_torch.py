...
def main():
    ...
    parser.add_argument(
        "-emb_file_enc", required=True, help="source Embeddings from this file"
    )
    parser.add_argument(
        "-emb_file_dec", required=True, help="target Embeddings from this file"
    )
    parser.add_argument(
    ...
    logger.info("\nMatching: ")
    match_percent = [
        _["match"] / (_["match"] + _["miss"]) * 100 for _ in [enc_count, dec_count]
    ]
    logger.info(
